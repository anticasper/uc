...
function createMarkerIcon(tone = "default") {
  ...
  const logo = markerLogoUrl
    ? `<img src="${escapeAttribute(markerLogoUrl)}" alt="" width="8" height="8" loading="lazy" style="display:block;width:8px!important;height:8px!important;max-width:8px!important;max-height:8px!important;object-fit:contain!important;">`
    : `<span aria-hidden="true"></span>`;

  return L.divIcon({
    className: "",
    html: `
      <div class="pin-marker ${toneClass}" style="width:8px!important;height:8px!important;overflow:hidden!important;">
        ${logo}
      </div>
    `,
    iconSize: [8, 8],
