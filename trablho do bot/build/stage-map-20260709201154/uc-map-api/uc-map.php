  ...
  <script>
    (function () {
      ...
      function replaceLegacyTestimonial() {
        ...
        const carousel = document.querySelector(".elementor-widget-n-carousel, [data-widget_type='nested-carousel.default'], .e-n-carousel");

        if (!heading || !carousel) return;

        let section = heading.closest(".e-con, .elementor-section, .elementor-container");
        while (section && !section.contains(carousel)) {
